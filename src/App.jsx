...
import { 
  ...
  BarChart3, Grid, Layers, Sun, Moon, HelpCircle,
...
function AppContent() {
  ...
  if (showIntro) {
    return <IntroScreen onEnter={() => setShowIntro(false)} theme={theme} toggleTheme={toggleTheme} />;
  }
      ...
      <aside className="sidebar">
        ...
        <nav>
          ...
          >
            ...
            {!fileConnected && <Lock size={12} style={{ opacity: 0.5 }} />}
          </button>
          ...
          <button 
            ...
            style={{ 
              justifyContent: 'space-between', 
              background: activeTool === 'groups' ? 'var(--bg-card-hover)' : 'transparent',
              borderColor: activeTool === 'groups' ? 'var(--border-color-hover)' : 'transparent',
              color: activeTool === 'groups' ? 'var(--text-main)' : 'var(--text-muted)',
              borderRadius: '12px',
              padding: '0.7rem 1.15rem',
              fontSize: '0.88rem'
            }}
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
              <Layers size={16} style={{ color: activeTool === 'groups' ? 'var(--primary)' : 'var(--text-muted)', transition: 'color 0.2s' }} />
              <span>Group Maker & Picker</span>
            </div>
            {!fileConnected && <Lock size={12} style={{ opacity: 0.5 }} />}
          </button>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', borderTop: '1px solid var(--border-color)', paddingTop: '1.25rem' }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            ...
            <button 
              ...
              title="EduKit Portal Help Guide"
            >
