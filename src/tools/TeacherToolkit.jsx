...
export default function TeacherToolkit() {
  ...
  const qaMatrix = [
    { role: "Shanif", task: "Check for grades that are lower than the previous AP and alert relevant SubCos.", ap: "AP3 - AP5" },
    { role: "Shanif", task: "Check overall attainment benchmarks against the KHDA inspection framework and inform Deputy Headteacher Academics.", ap: "AP3 & AP5" },
    { role: "SubCos", task: "Check for missing data (obtain spreadsheet from Shanif) and chase up teachers, providing a strict 2 days to rectify.", ap: "All APs" },
    ...
    { role: "Jill, GLCs & Assistant GLCs", task: "QA of comment banks: Read, amend, and test comment banks for Homeroom Tutor comments. Inform Shanif when satisfied.", ap: "AP3 (Tutor comments)" },
    { role: "Dan, SubCos & Assistant SubCos", task: "QA of comment banks: Read, amend, and test comment banks for Teacher Subject comments. Inform Shanif when satisfied.", ap: "AP5 (Subject comments)" },
    { role: "GLCs & Assistant GLCs", task: "QA of reports: Read tutor comments, alert Homeroom Tutors of required changes, and inform Jill when complete.", ap: "AP3" },
    { role: "Jill", task: "QA of reports: Spot check tutor comments post-GLC check and inform GLCs of any issues. Inform Shanif when reports are ready to go.", ap: "AP3" },
    { role: "SLT, SubCos & Assistant SubCos", task: "QA of reports: Read full reports for an assigned Homeroom. Alert SubCos of required changes, and inform Shanif when reports are ready. (SLT: 2 full classes each; SubCos: 1 full class each).", ap: "AP5" },
  ];
