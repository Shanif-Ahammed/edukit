...
export default function ATLTracker() {
  ...
  return (
    <div className="animate-fade-in" style={{ paddingBottom: '3rem' }}>
      ...
      </div>      {/* Row 1: Overall Class Gradebook Preview (Full Width) */}
      <div className="glass-panel animate-fade-in" style={{ padding: '1.5rem 1.75rem', display: 'flex', flexDirection: 'column', overflow: 'hidden', marginBottom: '2rem' }}>
      ...
      {/* Row 2: ATL Progress Distribution and Strategic ATL Insight (Side-by-Side Grid) */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))', gap: '2rem', alignItems: 'stretch' }}>
