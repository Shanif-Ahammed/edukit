...
const ATL_LEVELS = [
  { value: 'Expert', color: '#10b981', gradient: ['#10b981', '#059669'], bg: 'rgba(16, 185, 129, 0.08)', border: 'rgba(16, 185, 129, 0.25)', text: '#10b981' },
  { value: 'Practitioner', color: '#3b82f6', gradient: ['#3b82f6', '#2563eb'], bg: 'rgba(59, 130, 246, 0.08)', border: 'rgba(59, 130, 246, 0.25)', text: '#3b82f6' },
  { value: 'Beginner', color: '#f59e0b', gradient: ['#f59e0b', '#d97706'], bg: 'rgba(245, 158, 11, 0.08)', border: 'rgba(245, 158, 11, 0.25)', text: '#f59e0b' },
  { value: 'Novice', color: '#ef4444', gradient: ['#ef4444', '#dc2626'], bg: 'rgba(239, 68, 68, 0.08)', border: 'rgba(239, 68, 68, 0.25)', text: '#ef4444' }
];
...
const STRATEGY_INSIGHTS = {
  Expert: {
    ...
    description: 'The majority of this class is performing at an Expert ATL level. Focus on developing leadership and student-led inquiry.',
  ...
  Practitioner: {
    ...
    description: 'A solid core of Practitioner ATL performers. Transition from teacher-guided work to fully independent criterion reflections.',
    action: 'Incorporate self-assessment reflection milestones in major criterion tasks.'
  },
  Beginner: {
    title: 'Scaffolding ATL Competencies',
    description: 'Most students are Beginners. Introduce explicit checklists and step-by-step graphic organizers to build confidence.',
    action: 'Provide visual progress tracker sheets and hold short target-setting warmups.'
  },
  Novice: {
    title: 'Urgent Structural Support',
    description: 'A significant volume of Novice ratings requires explicit skill instruction and close monitoring.',
...
export default function ATLTracker() {
  ...
  classStudents.forEach(s => {
    const progress = s.atlProgress || 'Practitioner';
    if (atlCounts[progress] !== undefined) {
      atlCounts[progress]++;
    } else {
      atlCounts.Practitioner++;
    }
  ...
  const activeStrategy = STRATEGY_INSIGHTS[dominantCategory] || STRATEGY_INSIGHTS.Practitioner;

  // Cycle student's ATL Progress
  const cycleStudentATL = (studentId, currentScore) => {
    const levels = ['Expert', 'Practitioner', 'Beginner', 'Novice'];
    const idx = levels.indexOf(currentScore || 'Practitioner');
  ...
  return (
    <div className="animate-fade-in" style={{ paddingBottom: '3rem' }}>
      ...
      </div>      {/* Dynamic Responsive Layout Container (Auto-adjusts side-by-side or stacked on zoom/resize) */}
      <div style={{
        display: 'flex',
        flexWrap: 'wrap',
        gap: '2rem',
        ...
        {/* Card 1: Overall Class Gradebook Preview */}
        <div className="glass-panel animate-fade-in" style={{
          flex: '2 1 600px',
          minWidth: '320px',
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', minWidth: '600px' }}>
              ...
              <tbody>
                {classStudents.map((s, idx) => {
                  const sAtl = s.atlProgress || 'Practitioner';
        ...
        {/* Right Column Wrapper (Contains SVG Chart & Strategic Insight; auto-adjusts horizontally or vertically based on space) */}
        <div style={{
          flex: '1.5 1 380px',
          display: 'flex',
          flexDirection: 'row',
          ...
          {/* Card 2: ATL Progress Distribution */}
          <div className="glass-panel animate-fade-in" style={{
            flex: '1 1 360px',
            minWidth: '320px',
            padding: '1.5rem 1.75rem',
          ...
          {/* Card 3: CLASSROOM RECOMMENDATIONS & STRATEGY INSIGHT CARD */}
          <div className="glass-panel animate-fade-in" style={{
            flex: '1 1 360px',
            minWidth: '320px',
            padding: '1.5rem 1.75rem',
